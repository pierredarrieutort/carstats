...
module.exports = {
  ...
  icons: [
    {
      src: path.resolve('public/images/icon-16x16.png'),
      size: '16x16',
      type: 'image/png',
      purpose: 'any'
    },
    {
      src: path.resolve('public/images/icon-32x32.png'),
      size: '32x32',
      type: 'image/png',
      purpose: 'any'
    },
    {
      src: path.resolve('public/images/icon-57x57.png'),
      size: '57x57',
      type: 'image/png',
      purpose: 'any'
    },
    {
      src: path.resolve('public/images/icon-60x60.png'),
      size: '60x60',
      type: 'image/png',
      purpose: 'any'
    },
    ...
    {
      src: path.resolve('public/images/icon-76x76.png'),
      size: '76x76',
      type: 'image/png',
      purpose: 'any'
    },
    ...
    {
      src: path.resolve('public/images/icon-120x120.png'),
      size: '120x120',
      type: 'image/png',
      purpose: 'any'
    },
    ...
    {
      src: path.resolve('public/images/icon-167x167.png'),
      size: '167x167',
      type: 'image/png',
      purpose: 'any'
    },
    {
      src: path.resolve('public/images/icon-180x180.png'),
      size: '180x180',
      type: 'image/png',
      purpose: 'any'
    },
